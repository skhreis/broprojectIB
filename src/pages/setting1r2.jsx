...
function Setting1r2(){
    ...
    return(
        <div class='body'>
            <center><div class='text'>Following your defeat at the hands of the Sea People, you have two options. You can now either retreat back to saftey,
            ...
            {next ? (<div class='next'><a href='/setting1r3'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </center>
        </div>
    )
}
