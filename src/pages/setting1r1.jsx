...
function Setting1r1(){
    ...
    return(
        <div class='body'>
            <center><div class='text'>You are now one of the Pharoahs of Ancient Egypt, during the bronze age collapse! The system of international trade which your empire used to rely on has now collapsed, 
            ...
            {next ? (<div class='next'><a href='/setting1r2'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </center>
        </div>
    )
}
