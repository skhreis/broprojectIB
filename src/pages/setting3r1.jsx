...
function Setting3r1(){
    ...
    return(
        <div class='body'><center>
            ...
            <div class='text'>YThe imfamous Napoleon has escaped from his imprisonment on the island of Elba, and has quickly regained control over all of France. 
            ...
            {next ? (<div><a href='/setting3r2'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </div>
            </center>
        </div>
    )
