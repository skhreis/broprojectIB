...
function Setting2r1(){
    ...
    return(
        <div class='body'><center>
            ...
            <div class='text'>You are Julius Ceaser, and after your victory against the General Pompey in the Roman Civil War, you have been appointed as the life-long dictator of Rome. 
            ...
            {next ? (<div><a href='/setting2r2'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </div>
            </center>
        </div>
    )
