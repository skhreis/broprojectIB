...
function Setting4r1(){
    ...
    return(
        <div class='body'>
            ...
            {next ? (<div class='next'><a href='/setting4r2'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </center>
        </div>
    )
}
