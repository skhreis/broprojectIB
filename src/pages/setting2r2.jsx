...
function Setting2r2(){
    ...
    return(
        <div class='body'>
            <center><div class='text'>      As you are making your way to the meeting, you see the priest Spurina, who had previously told you that the Ides of March were a dangerous time for you. 
                You call out to him: 
            ...
            {next ? (<div class='next'><a href='/setting2r3'><button class='next'>Next</button></a></div>) : (<div></div>)}
            </center>
        </div>
    )
}
